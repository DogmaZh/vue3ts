<template>
  <div class="favorites">
    <h1 class="favorites__title">Favorite Dogs List</h1>
    <cards-list v-if="favoriteList.length > 0">
      <card-item
    ...
    <h3 v-else class="favorites__not-found">Add more dogs to your favorite!</h3>
  </div>
</template>
